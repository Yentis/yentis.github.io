...
async function readUrl(site: BaseSite): Promise<void> {
  ...
  desired.image = 'https://yuzuki.kagane.to/api/v2/image/019c29bc-0809-70e8-b5c3-9fd032cfb619/compressed'
...
async function readUrlAlt(): Promise<void> {
  ...
  desired.image = 'https://yuzuki.kagane.to/api/v2/image/019c2a33-d384-76ce-9c63-66887baf4394/compressed'
  desired.title = 'All My Neighbors are Convinced the Female Knight from My Rice Field Is My Wife'
  desired.chapterUrl =
    'https://kagane.to/series/019c2a33-d3b2-777b-871b-a093e2cf7701/reader/019cd22a-ce9b-7401-ba65-ecf2cf73254c'
