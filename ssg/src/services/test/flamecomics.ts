...
async function readUrl(site: BaseSite): Promise<void> {
  ...
  desired.image =
    'https://flamecomics.xyz/_next/image?url=https%3A%2F%2Fcdn.flamecomics.xyz%2Fuploads%2Fimages%2Fseries%2F61%2Fthumbnail.png&w=1920&q=100'
  ...
  desired.chapterDate = moment('1732178940', 'X').fromNow()
...
async function search(site: BaseSite): Promise<void> {
  ...
  const desired = new Manga(site.getTestUrl(), SITE_TYPE)
  desired.image =
    'https://flamecomics.xyz/_next/image?url=https%3A%2F%2Fcdn.flamecomics.xyz%2Fuploads%2Fimages%2Fseries%2F3%2Fthumbnail.png&w=1920&q=100'
