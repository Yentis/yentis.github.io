...
async function readUrl(site: BaseSite): Promise<void> {
  ...
  desired.image =
    'https://i4.mangapicgallery.com/r/coverlink/rROHYYKHa8HfkSK8mmW4eWJBGaTgrnCog_d0Y_sc68XnD0ocHUlXfyDZTt-I5lBX9PK.jpg?4'
...
async function search(site: BaseSite): Promise<void> {
  ...
  const desired = new Manga(site.getTestUrl(), SITE_TYPE)
  desired.image =
    'https://i3.mangapicgallery.com/r/coverlink/rROHYYKHa8HiliDzWniyeapxzJzU4oSoQvrAEzs86qJ0-9a9KsW_WCWDR6JmMILwX7iiPFrhc1qQVGKUHxoNO0X_TxZml7V2h2XjXDYSPEeBcveUNZKJki_m9uxZhO_YTR6I5lBX9PK.jpg?4'
